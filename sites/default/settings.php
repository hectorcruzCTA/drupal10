 ...
 * @endcode
 */
$settings['hash_salt'] = 'WBlClmL0gYMLIKuP0pVMHa3FTruy_kJNWaxDQTM_crYrswouxWQaO_K_rJbsWzETREj5H4tkUQ';
 ...
 */
$settings['file_private_path'] = '/var/www/html/drupal100/private';
...
$settings['trusted_host_patterns'] = [
  ...
  '^148\.202\.102\.216$', // La IP pública del servidor
  '^example\.com$', // Reemplaza con el dominio real cuando esté listo
];
